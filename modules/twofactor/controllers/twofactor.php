...
require_once dirname(__DIR__) . '/models/twofactor.php';

class Twofactor_Controller extends Controller {
	protected $model;
	...
	public function invalidate() {
		return $this->model->invalidate($_REQUEST['fingerprint']);
	}
}
