...
class Util {
	...
	public static function get_browser_language() {
		$lang_code = (isset($_SERVER['HTTP_ACCEPT_LANGUAGE']) && file_exists('i18n/' . substr($_SERVER['HTTP_ACCEPT_LANGUAGE'], 0, 2) . '.json')) ? substr($_SERVER['HTTP_ACCEPT_LANGUAGE'], 0, 2) : 'en';
		return json_decode(file_get_contents('i18n/' . $lang_code . '.json'), true);
	}
